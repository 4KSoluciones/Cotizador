...
*   >>> NUEVO: Descartar intervalos excluidos (ZTPARAM_COTSERV)
    ...
    IF sy-subrc = 0.
      IF lw_interv_excl-valor1 IS NOT INITIAL.
        DELETE gt_pauta WHERE intervalo_mine = lw_interv_excl-valor1.
      ENDIF.
      IF lw_interv_excl-valor2 IS NOT INITIAL.
        DELETE gt_pauta WHERE intervalo_mine = lw_interv_excl-valor2.
      ENDIF.
      IF lw_interv_excl-valor3 IS NOT INITIAL.
        DELETE gt_pauta WHERE intervalo_mine = lw_interv_excl-valor3.
      ENDIF.
      IF lw_interv_excl-valor4 IS NOT INITIAL.
        DELETE gt_pauta WHERE intervalo_mine = lw_interv_excl-valor4.
      ENDIF.
    ENDIF.
*   <<< FIN NUEVO
=======
...
<<<<<<< HEAD
    ...
    lw_cotizacion-contrat_4500 = lv_prepago3_acum.
    lw_cotizacion-contrat_6000 = lv_prepago4_acum.
